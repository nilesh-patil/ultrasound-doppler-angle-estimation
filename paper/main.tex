...
% Reproducible build: keep the pdfTeX/system banner out of the PDF metadata.
...
A preliminary version of this work was published in the Proceedings of the IEEE
Engineering in Medicine and Biology Society Conference (EMBC), 2019~\cite{Patil2019}.
This article extends it with dual-protocol evaluation, Optuna head tuning, a
five-backbone ensemble, and a clinical-grade evaluation suite.}}
\vspace{0.6em}
\end{center}
